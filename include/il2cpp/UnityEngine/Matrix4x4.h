...
void UnityEngine_Matrix4x4__SetTRS (UnityEngine_Matrix4x4_o __this, UnityEngine_Vector3_o pos, UnityEngine_Quaternion_o q, UnityEngine_Vector3_o s, const MethodInfo* method);
...
UnityEngine_Matrix4x4_o UnityEngine_Matrix4x4__Ortho (float left, float right, float bottom, float top, float zNear, float zFar, const MethodInfo* method);
...
void UnityEngine_Matrix4x4__Ortho_Injected (float left, float right, float bottom, float top, float zNear, float zFar, UnityEngine_Matrix4x4_o* ret, const MethodInfo* method);
