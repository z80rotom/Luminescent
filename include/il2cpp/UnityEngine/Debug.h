...
void UnityEngine_Debug__Assert (bool condition, const MethodInfo* method);
void UnityEngine_Debug__Assert (bool condition, System_String_o* message, const MethodInfo* method);
void UnityEngine_Debug__LogAssertion (Il2CppObject* message, const MethodInfo* method);
