...
void UnityEngine_Quaternion__Set (UnityEngine_Quaternion_o __this, float newX, float newY, float newZ, float newW, const MethodInfo* method);
...
void UnityEngine_Quaternion__SetLookRotation (UnityEngine_Quaternion_o __this, UnityEngine_Vector3_o view, UnityEngine_Vector3_o up, const MethodInfo* method);
...
void UnityEngine_Quaternion__set_eulerAngles (UnityEngine_Quaternion_o __this, UnityEngine_Vector3_o value, const MethodInfo* method);
...
void UnityEngine_Quaternion__Normalize (UnityEngine_Quaternion_o __this, const MethodInfo* method);
