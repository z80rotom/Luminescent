...
void UnityEngine_GUILayoutUtility__BeginContainer (UnityEngine_GUILayoutUtility_LayoutCache_o* cache, const MethodInfo* method);
...
void UnityEngine_GUILayoutUtility__LayoutFromContainer (float w, float h, const MethodInfo* method);
