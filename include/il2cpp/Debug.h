...
void Debug__Assert (bool condition, System_String_o* message, UnityEngine_Object_o* context, const MethodInfo* method);
void Debug__Assert (bool condition, Il2CppObject* message, UnityEngine_Object_o* context, const MethodInfo* method);
void Debug__Assert (bool condition, System_String_o* message, const MethodInfo* method);
void Debug__Assert (bool condition, Il2CppObject* message, const MethodInfo* method);
void Debug__Assert (bool condition, UnityEngine_Object_o* context, const MethodInfo* method);
void Debug__Assert (bool condition, const MethodInfo* method);
void Debug__Assert (bool condition, System_String_o* format, System_Object_array* args, const MethodInfo* method);
void Debug__AssertFormat (bool condition, System_String_o* format, System_Object_array* args, const MethodInfo* method);
void Debug__AssertFormat (bool condition, UnityEngine_Object_o* context, System_String_o* format, System_Object_array* args, const MethodInfo* method);
void Debug__Break (const MethodInfo* method);
void Debug__ClearDeveloperConsole (const MethodInfo* method);
void Debug__DebugBreak (const MethodInfo* method);
void Debug__DrawLine (UnityEngine_Vector3_o start, UnityEngine_Vector3_o end, UnityEngine_Color_o color, float duration, bool depthTest, const MethodInfo* method);
...
void Debug__DrawRay (UnityEngine_Vector3_o start, UnityEngine_Vector3_o dir, UnityEngine_Color_o color, float duration, bool depthTest, const MethodInfo* method);
...
void Debug__LogErrorFormat (UnityEngine_Object_o* context, System_String_o* format, System_Object_array* args, const MethodInfo* method);
...
void Debug__LogFormat (UnityEngine_Object_o* context, System_String_o* format, System_Object_array* args, const MethodInfo* method);
...
void Debug__LogWarningFormat (UnityEngine_Object_o* context, System_String_o* format, System_Object_array* args, const MethodInfo* method);
