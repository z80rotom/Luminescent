...
namespace EvData
{
    enum EvCmdID
    {
		...
		_GET_WATER_GYM_WATER_LEVEL = 1226,
        _REGET_WATER_GYM_WATER_LEVEL = 1227,
        _PLAY_REPORT_BTLTOWER_WIN = 1228,
        _TEMOTI_FORMNO = 1229,
        _TEMOTI_BOX_FORMNO = 1230,
        _GET_BOX_POKE_SEIKAKU = 1231,
        _RELEASE_BOX_POKE = 1232,
        _ETERNA_GYM_CLOCK_ROTATION = 1233,
        _ETERNA_GYM_CLOCK_ROTATION_INSTANT = 1234,
    };
}
